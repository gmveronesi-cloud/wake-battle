...
| Occhi aperti, trova l'oggetto | da fare | — | — |
| Esercizi (video) | da fare | — | — |

**PROSSIMO passo (nuova chat): il prossimo gioco dalla lista** — uno degli altri "fisici" con fotocamera (occhi aperti, trova l'oggetto: riusano le funzioni generiche di games.js scritte per Accendi la luce, cambia solo l'analisi del frame) oppure Esercizi (video registrato nell'app).

## Da fare ora (Gianmarco)
Caccia ai colori (nuovo, terzo gioco con fotocamera):
...
- SQL: test_02 (83), test_03 (63, DB senza 04), test_04 (53, rilanciato anche dopo 05/06/07/09/11/12/14/15/16), test_05 (45, rilanciato dopo 06/07/09/11/12/14/15/16), test_06 (61, rilanciato dopo 07/09/11/12/14/15/16), test_09 (11, rimozione Trova l'intruso, rilanciato dopo 11/12/14/15/16), test_11 (46, Riflessi "Babbo/Schiacciami", rilanciato dopo 12/14/15/16), test_12 (52, Anagramma, rilanciato dopo 14/15/16), test_14 (41, Accendi la luce, rilanciato dopo 15/16), test_15 (43, QR o codice a barre, rilanciato dopo 16), test_16 (48, Caccia ai colori); run.sh. prep_db.sh carica 01..03 + tutti i sql/0N_… presenti (`senza04` si ferma al 03). Boilerplate comune (connessione, orologio finto, ruoli, rpc/jrpc, contatori) in test/_lib.py. test_10.py/ui_test_10.js (prima versione di Riflessi) eliminati: sostituiti dall'11, stesso trattamento riservato a test_08/ui_test_08 quando è sparito Trova l'intruso. Il placeholder "gioco sconosciuto" usato da test_03..test_14 era il codice 'qr' (riservato ma non ancora implementato): dal 15 è un gioco vero, quindi tutti questi test sono stati aggiornati a usare 'barcode' come placeholder.
- UI: ui_test (33), ui_test_03 (43), ui_test_04 (34), ui_test_05 (27), ui_test_06 (32), ui_test_11 (22, Riflessi "Babbo/Schiacciami"), ui_test_12 (23, Anagramma), ui_test_14 (18, Accendi la luce), ui_test_15 (16, QR o codice a barre), ui_test_16 (18, Caccia ai colori); tutti.sh prende da solo ogni ui_test_0N.js.
