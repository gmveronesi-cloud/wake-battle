...
- UI: ui_test (33), ui_test_03 (43), ui_test_04 (34), ui_test_05 (27), ui_test_06 (32), ui_test_11 (22, Riflessi "Babbo/Schiacciami"), ui_test_12 (23, Anagramma), ui_test_14 (18, Accendi la luce), ui_test_15 (16, QR o codice a barre); tutti.sh prende da solo ogni ui_test_0N.js.
...
- cameraGame() (games.js) ha due opzioni per adattarsi al gioco (chiesto da Gianmarco dopo la prima versione di QR, che riusava alla lettera il comportamento di "Accendi la luce"): `showVideo` (default false, video nascosto; true per i giochi dove serve inquadrare qualcosa di preciso, es. QR/barcode) e `showBar` (default true; false per i giochi senza un livello progressivo da mostrare, es. QR/barcode: o si è letto un codice o no). "Accendi la luce" resta sui default (video nascosto + barra col countdown); "QR o codice a barre" usa showVideo:true, showBar:false. Classe CSS del video in diretta: `.cam-video`.
